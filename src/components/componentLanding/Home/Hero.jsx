      ...
      <div className="relative w-full h-full pb-10">
          ...
          <div className="relative z-10 mx-auto container hidden w-full px-4 xl:px-0 lg:flex justify-between items-center py-11">
            ...
            <div className="flex items-center text-white text-base font-medium">
              <ul className="flex items-center pr-3 xl:pr-12">
                ...
                <li
                  className="pl-3 lg:pl-5 xl:pl-8 cursor-pointer hover:text-gray-300 ease-in"
                  onClick={() => {
                    const getDocumentIDAbout =
                      document.getElementById("about_id");
                    getDocumentIDAbout.scrollIntoView({
                      behavior: "smooth",
                      block: "start",
                    });
                  }}
                ...
                <li
                  className=" pl-3 lg:pl-5 xl:pl-8 cursor-pointer hover:text-gray-300 ease-in"
                  onClick={() => {
                    const getIdELPrice = document.getElementById("price_id");
                    getIdELPrice.scrollIntoView({
                      behavior: "smooth",
                      block: "start",
                    });
                  }}
                ...
                <li
                  onClick={() => {
                    const getElPesanan = document.getElementById("pesanan_id");
                    getElPesanan.scrollIntoView({
                      behavior: "smooth",
                      block: "start",
                    });
                  }}
        ...
        <div className="relative px-4 xl:px-0 container mx-auto md:flex items-center gap-8 ">
          <div className="text-color w-full md:w-1/3 pt-16 lg:pt-32 xl:pt-12">
            ...
            >
              Cetak, Tugas Document Kantor & Skripsi Anda
            </h1>
            ...
            <div className="lg:flex">
              <button
                ...
                className="hidden md:block hover:opacity-90 text-base w-full xl:text-base xl:w-6/12 mt-4 xl:mt-8 f-f-r py-4  bg-indigo-700 text-white font-bold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 rounded-lg"
              >
                Pesan Sekarang
              </button>
              <button
                ...
                className="hidden md:block hover:opacity-90 text-base w-full xl:text-base xl:w-4/12 lg:ml-2 xl:ml-2 mt-4 xl:mt-8 f-f-r py-4  bg-indigo-200 text-indigo-600 font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 rounded-lg"
              >
                Liat Harga Dulu
              </button>
            </div>
