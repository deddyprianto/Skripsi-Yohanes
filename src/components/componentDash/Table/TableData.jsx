...
function TableData() {
  ...
  return (
    <div className="w-full flex justify-center">
      <div className="w-[95%]">
        <div className="mt-10 py-5 bg-blue-500 rounded-tl-lg rounded-tr-lg">
          <div className="sm:flex items-center justify-between">
            <p className="ml-2 text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-white">
              Table Pelanggan
            </p>
            <div>
              <button className="mr-2 inline-flex sm:ml-3 mt-4 sm:mt-0 items-start justify-start px-6 py-3 bg-sky-500 hover:bg-indigo-600 focus:outline-none rounded">
